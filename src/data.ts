...
export const INITIAL_GROUPS: Group[] = [
  ...
  },
  {
    ...
    description: "A community for audio purists, analog enthusiasts, and dark-roast espresso lovers. We gather in hidden basements to spin curated LPs of city pop, jazz, and post-punk.",
    category: "arts",
    membersCount: 121,
  ...
  },
  {
    ...
    nextMeetup: {
      ...
      date: "Tomorrow",
      time: "1:00 PM",
      location: "Devon's Kitchen Studio",
...
export const INITIAL_MEETUPS: MeetupEvent[] = [
  ...
  },
  {
    id: "m-3",
    title: "Secret Ramen Broth Mastery Exchange",
    description: "Learn molecular kitchen secrets with Devon. We will construct deep chicken-tonkotsu tare, and dehydrate our own custom mushroom spice sprinkles. Limited seats in Devon's culinary loft.",
    date: "Tomorrow",
    time: "1:00 PM",
    location: "Devon's Kitchen Studio",
    type: "group",
